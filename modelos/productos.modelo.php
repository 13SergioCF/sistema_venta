...
class ModeloProductos{
	...
	/*=============================================
MOSTRAR SUMA VENTAS EN DINERO
=============================================*/	

	static public function mdlMostrarSumaVentasDinero($tabla){

		// Consulta que obtiene la suma de dinero (ventas * precio_venta) para cada producto
		$stmt = Conexion::conectar()->prepare("SELECT descripcion, imagen, (ventas * precio_venta) as total_ventas, ventas FROM $tabla ORDER BY total_ventas DESC");
