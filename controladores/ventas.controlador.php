...
class ControladorVentas{
	...
	/*=============================================
    SUMA TOTAL VENTAS DEL DÍA
=============================================*/
	public static function ctrSumaTotalVentasDias(){

		$tabla = "ventas";

		$respuesta = ModeloVentas::mdlSumaTotalVentasDias($tabla);
...
=============================================*/
public static function ctrSumaTotalGanancias(){

    $tablaVentas = "ventas";
    $tablaProductos = "productos"; // Asumiendo que la tabla de productos se llama así

    $respuesta = ModeloVentas::mdlSumaTotalGanancias($tablaVentas, $tablaProductos);
